...
function Footer() {
    ...
    return (
       <footer style={foot}>
          <div>
             © Renascer Imóveis 2022. All rights reserverd
          </div>
          ...
          <a target='_blank' href="https://github.com/EdlayneOliveiraa/Terceiro-Projeto-Grupo-Sendo-servido"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="white" className="bi bi-github" viewBox="0 0 16 16">
